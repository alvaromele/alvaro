...
class Proveedores extends Controllers
{
	...
	public function Proveedores()
	{
		...
		$data['page_etiqueta'] = "Proveedores";
		$data['page_titulo'] = "Proveedores";
		$data['page_name'] = "proveedores";
		$data['page_funciones_js'] = "funciones_proveedores.js";
		$this->views->getVista($this, "proveedores", $data);
	}
	...
	public function eliminados($estado = 0)
	{
		if ($_SESSION['permisosMod']['d']) {
			...
			$data['page_title'] = "Proveedores Inactivos";
			$data['page_name'] = "proveedores";
			$data['proveedores'] = $arrData;
