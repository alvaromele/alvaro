...
class ProveedoresModel extends Mysql
{
    ...
    public function selectUsuarios()
    {
        ...
        $sql = "SELECT u.idusuario,u.identificacion,u.nombrefiscal,u.telefono,u.email_user,u.estado,r.idrol,r.nombrerol as nombrerol
					FROM usuarios u 
					INNER JOIN rol r
					ON u.rolid = r.idrol
					WHERE u.estado != 2 AND rolid = 5 ";
        $request = $this->select_all($sql);
        return $request;
    }
    ...
    public function selectUsuariosBorrados()
    {
        ...
        $sql = "SELECT u.idusuario,u.identificacion,u.nombrefiscal,u.telefono,u.email_user,u.estado,r.idrol,r.nombrerol 
					FROM usuarios u 
					INNER JOIN rol r
					ON u.rolid = r.idrol
					WHERE u.estado = 2 AND rolid = 5 ";
    ...
    public function selectUsuario(int $idusuario)
    {
        ...
        $sql = "SELECT u.*,r.idrol,r.nombrerol, DATE_FORMAT(u.fechacrea, '%d-%m-%Y') as fechaRegistro 
					FROM usuarios u
					INNER JOIN rol r
					ON u.rolid = r.idrol
					WHERE u.idusuario = $this->intIdUsuario AND rolid = 5";
