            ...
            <div class="col-md-8">
              ...
              <div class="row">
                ...
                <div class="form-group col-md-3">
                  <label for="listUnidades">Unidades <span class="required">*</span></label>
                  <select class="form-control" data-live-search="true" id="listUnidades" name="listUnidades" required=""></select>
                </div>
              </div>
              <div class="form-group">
            ...
            <div class="col-md-4">
              <div class="row">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" id="txtIva" name="txtIva" type="text" required="">
                </div>
              </div>
              ...
              <div class="row">
                <div class="form-group col-md-8">
                  <label for="listCategoria">Categorías <span class="required">*</span></label>
              ...
              <div class="form-group">
                ...
                <input class="form-control" value="  <?= $codigo['codigo'] + 1 ?>  " id="txtCodigo" name="txtCodigo" type="text" placeholder="Código de barra" required="" readonly>
                <br>
